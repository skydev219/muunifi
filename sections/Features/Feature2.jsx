      ...
      <Container>
        <Row className="position-relative">
          ...
          <Col className="d-flex align-items-center" md={6}>
            <div className={`${styles.blockInner} ${styles.textInner2} offset2 ${(play5) ? 'play' : ''}`}>
          ...
          <Col className={`d-flex align-items-center ${play3 ? 'play' : ''}`} md={6}>
            <div className="w-100 d-flex justify-content-end entry-1">
              <div className={`${styles.phone2} ${play3 ? 'play' : ''}`}>
                <Phone isHide={true} isOverflow isActive={isActive && play1}>
                  <div className={`${styles.phoneVideo2}`} ref={screen2AnimationContainer}></div>
                </Phone>
              </div>
            </div>
          </Col>
